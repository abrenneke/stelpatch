...
mod color_tests {
    ...
    fn test_color_valid_input_rgb() {
        ...
        assert_eq!(result, ("", ("rgb".to_string(), 255.0, 128.0, 0.0, None)));
    }

    #[test]
    fn test_color_valid_input_hsv() {
        let result = color::<ErrorTree<_>>("hsv { 120 0.5 1 }").unwrap();
        assert_eq!(result, ("", ("hsv".to_string(), 120.0, 0.5, 1.0, None)));
    }
    ...
    fn test_color_valid_input_rgb_with_alpha() {
        ...
        assert_eq!(
            result,
            ("", ("rgb".to_string(), 255.0, 128.0, 0.0, Some(0.5)))
        );
    }
    ...
    fn test_color_valid_input_hsv_with_alpha() {
        ...
        assert_eq!(
            result,
            ("", ("hsv".to_string(), 120.0, 0.5, 1.0, Some(0.8)))
        );
    }
